export const posts = [
  {
    question: 'How to start playing Battleverse?',
    answer: 'You need to connect your Metamask wallet and have a character',
  },
  {
    question: 'How to create a Metamask wallet?',
    answer: 'Go to <a href=`https://metamask.io` target=`_blank` rel=`noreferrer`>the Metamask</a> website, and click the “Download” button, which will take you to the relevant store to download the extension or app based on the device and browser you’re using. After installation, you can connect your Metamask wallet.',
  },
  {
    question: 'How to get a character?',
    answer: 'I can mint a Shroom or buy a Bot.',
  },
  {
  ...
  },
  {
    ...
    answer: 'You can swap any cryptocurrency to BVC on <a href=`https://pancakeswap.finance/swap?outputCurrency=0x9BEe0c15676a65ef3c8cdb38cB3DD31c675BbD12` target=`_blank` rel=`noreferrer`>PancakeSwap</a> or <a href=`https://www.bitmart.com/trade/en?symbol=BVC_USDT&layout=basic` target=`_blank` rel=`noreferrer`>Bitmart</a>',
  },
  {
    question:
